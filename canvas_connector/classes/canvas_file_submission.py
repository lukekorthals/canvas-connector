...
class CanvasFileSubmission:
    ...
    def __init__(self, 
                 ...
                 attachment_id: int, 
                 out_path: str = None,
                 path_template: str = "submissions/user-{user_id}/assignment-{assignment_id}/user-{user_id}_ass-{assignment_id}_try-{attempt}_que-{question_id}_att-{attachment_id}") -> None:
